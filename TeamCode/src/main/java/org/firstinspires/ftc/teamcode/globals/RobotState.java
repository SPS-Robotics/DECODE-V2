...
public class RobotState {
    ...
    public static Pose LOADING_ZONE = new Pose(72 + (72 * ALLIANCE_COLOR.getMultiplier()), 0, Math.toRadians(90 + (90 * ALLIANCE_COLOR.getMultiplier()))); // depends on robot centre - tune later.
}
